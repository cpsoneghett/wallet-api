...
public class WalletServiceImpl implements WalletService {
    ...
    @Override
    public com.cpsoneghett.walletapi.domain.entity.Wallet create() throws MnemonicException.MnemonicLengthException {
        ...
        return new com.cpsoneghett.walletapi.domain.entity.Wallet(address.toString(), privateKeyWIF.toString());
    }
